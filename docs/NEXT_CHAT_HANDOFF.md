...
Do not reconstruct from older June handoff notes or archived worktrees. The canonical worktree is:

```text
D:/Arbeit/0_ACTIVE/Recklinghausen
```

Do not commit raw customer exports, screenshots, audio files, `.hermes/`, `.agent/`, or secrets.
